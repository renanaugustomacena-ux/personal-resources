...
> **Position:** Phase 3 — Persistence and project structure · Module 09 (case study)
> **Prerequisites:** Modules 01-08.
> **Learning objectives:** internalize Relax Room architecture as a worked example: vision → signal-driven design → data flow → save system → content inventory. Use as a template for own projects.
> **Estimated time:** 60-90 min reading
> **Level:** competent → proficient
> **Last updated:** 2026-04-27

## Guiding ideas

1. **Real projects > tutorial code.** Tutorial code is contrived; production code shows trade-offs.
2. **Signal-driven architecture decouples scenes.** Adopt for own projects.
3. **Save system v4.0.0 chain shows migration discipline.** Real-world schema evolution.
4. **Content inventory documents scope.** Helps avoid scope creep.
...
1. **Read + analyze.** Read entire deep dive; identify 3 design decisions you would have made differently. Argue.
2. **Apply pattern.** Take the signal-driven architecture pattern and apply it to a different game type (e.g., RPG inventory).

## Cross-links

- Module 01-08 (foundations).
- `00-CAPSTONE.md`: capstone modeled on Relax Room scope.
